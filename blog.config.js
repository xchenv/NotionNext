...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '星辰', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '天地任逍遥', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-two-tan-75.vercel.app/', // 网站地址
